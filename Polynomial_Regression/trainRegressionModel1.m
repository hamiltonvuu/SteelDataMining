...
% Auto-generated by MATLAB on 05-Jun-2018 00:50:54
...
predictorNames = {'P', 'S', 'RR', 'I', 'HVN', 'lumpASP', 'lumpASP2'};
predictors = inputTable(:, predictorNames);
response = inputTable.cFS;
...
concatenatedPredictorsAndResponse.cFS = response;
linearModel = fitlm(...
...
trainedModel.RequiredVariables = {'P', 'S', 'RR', 'I', 'HVN', 'lumpASP', 'lumpASP2'};
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.cFS = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'linear', ...
        'RobustOpts', 'off',...
